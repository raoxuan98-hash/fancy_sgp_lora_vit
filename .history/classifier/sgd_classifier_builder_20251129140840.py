...
class SGDClassifierBuilder(BaseClassifierBuilder):
    def __init__(self, cached_Z = None, device="cuda", max_steps=4000, steps_per_class=3, lr=1e-3):
    ...
    def build(self, stats_dict, linear=True, alpha1=1.0, alpha2=0.0, alpha3=0.0):
        ...
        sch = torch.optim.lr_scheduler.CosineAnnealingLR(opt, T_max=max_steps, eta_min=1e-5)
