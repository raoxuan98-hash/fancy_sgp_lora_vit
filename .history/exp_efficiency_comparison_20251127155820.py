...
def plot_inference_time_comparison(
    ...
    # 统一 low-rank QDA 使用蓝色系（ColorBrewer Blues 调色）
    low_qda_colors = {
        'low_qda_r1': '#deebf7',   # 浅蓝
        'low_qda_r8': '#9ecae1',   # 中浅蓝
        'low_qda_r16': '#4292c6',  # 中蓝
        'low_qda_r32': '#08519c',  # 深蓝
    }
    ...
    styles = {
        ...
        **{k: {'color': v, 'linestyle': ['-', '--', '-.', ':'][i], 'marker': ['s', '^', 'D', 'v'][i], 'linewidth': 1.6}
    ...
    plt.ylim(0.005, 2.5)  # 保持原范围，但注意这是线性尺度
