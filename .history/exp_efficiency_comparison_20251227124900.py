...
def initialize_results_dict(classifier_types: List[str]) -> Dict[str, Union[Dict[str, List[float]], Optional[float]]]:
...
def run_efficiency_experiment(
    ...
    num_shots: int = 128,
    device: str = "cuda"
) -> Dict[str, Union[Dict[str, List[float]], Optional[float]]]:
...
def save_results(results: Dict[str, Union[Dict[str, List[float]], Optional[float]]], class_counts: List[int],
