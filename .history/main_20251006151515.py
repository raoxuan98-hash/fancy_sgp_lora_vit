...
def build_parser() -> argparse.ArgumentParser:
    ...
    train_grp.add_argument('--lrate', type=float, default=1e-2, help='Learning rate.')
    ...
    aux.add_argument('--auxiliary_data_path', type=str, default='D:/projects/datasets', help='Root path of the auxiliary dataset.')
