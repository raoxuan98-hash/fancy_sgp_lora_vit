...
def build_parser() -> argparse.ArgumentParser:
    ...
    basic.add_argument('--user', type=str, default='authors', choices=['authors'], help='User identifier (currently unused).')
    ...
    model.add_argument('--weight_decay', type=float, default=1e-4, help='Weight decay.')
    ...
    train_grp.add_argument('--lrate', type=float, default=3e-3, help='Learning rate.')
