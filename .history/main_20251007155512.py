...
def build_parser() -> argparse.ArgumentParser:
    ...
    model.add_argument('--weight_decay', type=float, default=1e-3, help='Weight decay.')
    ...
    model.add_argument('--weight_temp', type=float, default=4.0, help='Projection temperature.')
