...
def build_parser() -> argparse.ArgumentParser:
    ...
    basic.add_argument('--user', type=str, default='rebuttal', choices=['authors'], help='User identifier (currently unused).')
    ...
    model.add_argument('--weight_decay', type=float, default=1e-5, help='Weight decay.')
    ...
    train_grp.add_argument('--iterations', type=int, default=500, help='Training iterations per task.')
    ...
    aux.add_argument('--aux_dataset', type=str, default='ImageNet-2012', help='Dataset type for auxiliary data (e.g. imagenet, cifar).', choices=['ImageNet-2012', 'flickr8k'])
