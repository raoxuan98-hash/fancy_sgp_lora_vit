...
def build_parser() -> argparse.ArgumentParser:
    ...
    basic.add_argument('--user', type=str, default='rebuttal_compensate', choices=['authors'], help='User identifier (currently unused).')
    ...
    train_grp.add_argument('--gamma_norm', type=float, default=0.0, help='Norm regularisation weight.')
