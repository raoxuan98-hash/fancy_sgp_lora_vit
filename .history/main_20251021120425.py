...
def build_parser() -> argparse.ArgumentParser:
    ...
    basic.add_argument('--dataset', type=str, default='cars196_224', choices=['imagenet-r', 'cifar100_224', 'cub200_224', 'cars196_224', 'caltech101_224', 'oxfordpet37_224', 'food101_224', 'resisc45_224'], help='Dataset to use')
    ...
    cls.add_argument('--init_cls', type=int, default=194, help='Number of classes in the first task.')
    cls.add_argument('--increment', type=int, default=2, help='Number of new classes added per task.')
    ...
    model.add_argument('--weight_decay', type=float, default=, help='Weight decay.')
    ...
    train_grp.add_argument('--iterations', type=int, default=3000, help='Training iterations per task.')
