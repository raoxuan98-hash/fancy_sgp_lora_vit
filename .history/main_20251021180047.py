...
def build_parser() -> argparse.ArgumentParser:
    ...
    cls.add_argument('--init_cls', type=int, default=195, help='Number of classes in the first task.')
    cls.add_argument('--increment', type=int, default=1, help='Number of new classes added per task.')
