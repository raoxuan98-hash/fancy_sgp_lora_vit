...
def build_parser() -> argparse.ArgumentParser:
    ...
    cls.add_argument('--init_cls', type=int, default=200, help='Number of classes in the first task.')
    ...
    train_grp.add_argument('--iterations', type=int, default=10000, help='Training iterations per task.')
