...
def build_parser() -> argparse.ArgumentParser:
    ...
    gda.add_argument('--qda_reg_alpha1', type=float, default=0.2, help='QDA regularisation alpha 1.')
    gda.add_argument('--qda_reg_alpha2', type=float, default=0., help='QDA regularisation alpha 2.')
    gda.add_argument('--qda_reg_alpha3', type=float, default=0.25, help='QDA regularisation alpha 3.')
