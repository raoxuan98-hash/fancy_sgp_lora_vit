...
def build_parser() -> argparse.ArgumentParser:
    ...
    basic.add_argument('--user', type=str, default='sgp_lora_test', choices=['authors'], help='User identifier (currently unused).')
    ...
    train_grp.add_argument('--seed_list', nargs='+', type=int, default=[1993, 1996, 1998], help='Random seeds for multiple runs.')
