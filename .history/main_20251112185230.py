...
def build_parser() -> argparse.ArgumentParser:
    ...
    basic.add_argument('--dataset', type=str, default='cifar100_224',
                       choices=['imagenet-r', 'cifar100_224', 'cub200_224', 'cars196_224',
                                'caltech101_224', 'oxfordpet37_224', 'food101_224', 'resisc45_224',
                                'cross_domain_elevater'],
                       help='Dataset to use')
    ...
    basic.add_argument('--cross_domain', action='store_true', default=False,
                        help='Enable cross-domain class-incremental learning')
    basic.add_argument('--cross_domain_datasets', type=str, nargs='+',
                        default=['caltech-101', 'dtd', 'eurosat_clip', 'fgvc-aircraft-2013b-variants102',
