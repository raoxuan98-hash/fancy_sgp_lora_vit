...
def build_parser() -> argparse.ArgumentParser:
    ...
    basic.add_argument('--cross_domain', action='store_true', default=False, help='Enable cross-domain class-incremental learning')
    basic.add_argument('--cross_domain_datasets', type=str, nargs='+', default=['caltech-101', 'dtd', 'eurosat_clip', 'fgvc-aircraft-2013b-variants102', 'food-101', 'mnist', 'oxford-flower-102', 'oxford-iiit-pets', 'stanford-cars', 'imagenet-r'], help='List of datasets for cross-domain experiments')
