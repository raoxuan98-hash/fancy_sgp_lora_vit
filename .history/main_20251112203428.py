...
def build_parser() -> argparse.ArgumentParser:
    ...
    basic.add_argument('--cross_domain_datasets', type=str, nargs='+', default=['imagenet-r', 'caltech-101', 'dtd', 'eurosat_clip', 'fgvc_aircraft', 'food101', 'mnist', 'oxford_flower102', 'oxford_pets', 'cars196_224'], help='List of datasets for cross-domain experiments')
