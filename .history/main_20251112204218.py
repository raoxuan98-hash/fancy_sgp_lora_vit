...
def build_parser() -> argparse.ArgumentParser:
    ...
    basic.add_argument('--cross_domain_datasets', type=str, nargs='+', default=['imagenet-r', 'caltech-101', 'dtd', 'eurosat', 'aircraft', 'food101', 'mnist', 'flower102', 'oxford_pets', 'cars196_224'], help='List of datasets for cross-domain experiments')
