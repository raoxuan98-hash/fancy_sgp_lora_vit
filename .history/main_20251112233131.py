...
def build_parser() -> argparse.ArgumentParser:
    ...
    basic.add_argument('--num_shots', type=int, default=0, help='Number of samples per class for few-shot learning. If > 0, randomly sample num_shots samples per class.')
