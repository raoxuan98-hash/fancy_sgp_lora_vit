...
def set_smart_defaults(ns):
    ...
    if ns.dataset == 'cars196_224':
        ...
        ns.iterations = 1500  # 跨域实验默认使用1500次迭代
...
def build_parser() -> argparse.ArgumentParser:
    ...
    gda.add_argument('--qda_reg_alpha2', type=float, default=0.80, help='QDA regularisation alpha 2.')
    gda.add_argument('--qda_reg_alpha3', type=float, default=0.05, help='QDA regularisation alpha 3.')
