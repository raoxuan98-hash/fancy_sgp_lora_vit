...
def set_smart_defaults(ns):
    ...
    elif ns.dataset == 'cross_domain_elevater':
        ns.iterations = 1500
...
def build_parser() -> argparse.ArgumentParser:
    ...
    # basic.add_argument('--cross_domain_datasets', type=str, nargs='+', default=['cifar100_224', 'cub200_224', 'resisc45', 'imagenet-r', 'caltech-101', 'dtd', 'fgvc-aircraft-2013b-variants102', 'food-101', 'mnist', 'oxford-flower-102', 'oxford-iiit-pets', 'cars196_224'], help='List of datasets for cross-domain experiments')
    basic.add_argument('--cross_domain_datasets', type=str, nargs='+', default=['imagenet-r'], help='List of datasets for cross-domain experiments')
    ...
    gda.add_argument('--qda_reg_alpha2', type=float, default=2.50, help='QDA regularisation alpha 2.')
