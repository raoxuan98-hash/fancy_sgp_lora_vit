...
def build_parser() -> argparse.ArgumentParser:
    ...
    basic.add_argument('--cross_domain_datasets', type=str, nargs='+', default=['cifar100_224', 'cub200_224', 'caltech-101', 'imagenet-r', 'cars196_224'], help='List of datasets for cross-domain experiments')
    ...
    comp.add_argument('--compensator_types', type=str, nargs='+', default=['SeqFT', 'SeqFT + Hopfield'],
                     choices=['SeqFT', 'SeqFT + linear', 'SeqFT + weaknonlinear', 'SeqFT + Hopfield'],
                     help='Types of compensators to use. Default is all four types.')
