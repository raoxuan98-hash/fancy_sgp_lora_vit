...
def build_parser() -> argparse.ArgumentParser:
    ...
    basic.add_argument('--cross_domain_datasets', type=str, nargs='+', default=['cifar100_224', 'imagenet-r', 'cars196_224', 'cub200_224', 'caltech-101'], help='List of datasets for cross-domain experiments')
    ...
    inc.add_argument('--num_incremental_splits', type=int, default=5,
    ...
    comp.add_argument('--hopfield_topk', type=int, default=1000, help='Top-k parameter for Hopfield attention compensator.')
