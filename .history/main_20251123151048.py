...
def build_parser() -> argparse.ArgumentParser:
    ...
    basic.add_argument('--cross_domain_datasets', type=str, nargs='+', default=['cifar100_224', 'imagenet-r', 'cars196_224', 'cub200_224', 'caltech-101', 'oxford-flower-102', 'food-101', 'fgvc-aircraft-2013b-variants102'], help='List of datasets for cross-domain experiments')
    ...
    comp.add_argument('--hopfield_topk', type=int, default=100, help='Top-k parameter for Hopfield attention compensator.')
