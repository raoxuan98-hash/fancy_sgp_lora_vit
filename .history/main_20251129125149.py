...
def build_parser() -> argparse.ArgumentParser:
    ...
    train_grp.add_argument('--iterations', type=int, default=1000, help='Training iterations per task.')
    ...
    comp.add_argument('--compensator_types', type=str, nargs='+', default=['SeqFT', 'SeqFT + rff', 'SeqFT + linear', 'SeqFT + weaknonlinear'],
