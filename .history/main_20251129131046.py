...
def build_parser() -> argparse.ArgumentParser:
    ...
    train_grp.add_argument('--evaluate_final_only', action=argparse.BooleanOptionalAction, default=False)
    ...
    aux.add_argument('--auxiliary_data_size', type=int, default=2096, help='Number of samples drawn from the auxiliary dataset each epoch.')
