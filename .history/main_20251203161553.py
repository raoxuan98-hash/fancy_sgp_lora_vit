...
def build_parser() -> argparse.ArgumentParser:
    ...
    basic.add_argument('--dataset', type=str, default='cars196_224', choices=['imagenet-r', 'cifar100_224', 'cub200_224', 'cars196_224', 'caltech101_224', 'oxfordpet37_224', 'food101_224', 'resisc45_224', 'cross_domain_elevater'], help='Dataset to use')
    ...
    comp.add_argument('--compensator_types', type=str, nargs='+', default=['SeqFT', 'SeqFT + Hopfield', 'SeqFT + linear'],
