...
def set_smart_defaults(ns):
    ...
    if ns.dataset == 'cars196_224':
        ...
        if ns.gamma_kd > 0:
            ns.iterations = 2000 # 使用知识蒸馏时的迭代次数
        else:
...
def build_parser() -> argparse.ArgumentParser:
    ...
    model.add_argument('--model_name', type=str, default='LR-RGDA', help='Model identifier.')
    ...
    comp.add_argument('--compensator_types', type=str, nargs='+', default=['SeqFT', 'SeqFT + weaknonlinear', 'SeqFT + Hopfield'], 
    ...
    comp.add_argument('--hopfield_topk', type=int, default=500, help='Top-k parameter for Hopfield attention compensator.')
