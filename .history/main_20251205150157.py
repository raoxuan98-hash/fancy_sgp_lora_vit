...
def build_parser() -> argparse.ArgumentParser:
    ...
    model.add_argument('--lora_type', type=str, default="full_nsp", choices=['basic_lora', 'sgp_lora', 'nsp_lora', 'full', 'full_nsp', 'joint_lora', 'joint_full'], help='Type of LoRA adaptor.')
