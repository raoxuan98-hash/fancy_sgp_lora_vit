...
def build_parser() -> argparse.ArgumentParser:
    ...
    basic.add_argument('--user', type=str, default='2025-11-04-within_', choices=['authors'], help='User identifier (currently unused).')
    ...
    model.add_argument('--lora_type', type=str, default="joint_full", choices=['basic_lora', 'sgp_lora', 'nsp_lora', 'full', 'full_nsp', 'joint_lora', 'joint_full'], help='Type of LoRA adaptor.')
    ...
    interp.add_argument('--interpolation_alpha', type=float, default=0.6, help='Weight interpolation alpha value. Set to 1.0 to disable interpolation. Range [0.0, 1.0]. 0.0=use only prev_net, 1.0=use only current net, 0.5=equal weighting.')
    interp.add_argument('--enable_weight_interpolation', action="store_true", default=True, help='Enable weight interpolation with previous network.')
    
    # 分类器参数
    cls.add_argument('--classifier_types', type=str, nargs='+', default=['lda', 'qda'], choices=['lda', 'qda', 'sgd', 'ls'], help='Types of classifiers to build. Default is both LDA and QDA.')
