...
def build_parser() -> argparse.ArgumentParser:
    ...
    interp.add_argument('--interpolation_alpha', type=float, default=0.5, help='Weight interpolation alpha value. Set to 1.0 to disable interpolation. Range [0.0, 1.0]. 0.0=use only prev_net, 1.0=use only current net, 0.5=equal weighting.')
