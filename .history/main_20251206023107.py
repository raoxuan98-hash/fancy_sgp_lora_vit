...
def build_parser() -> argparse.ArgumentParser:
    ...
    basic.add_argument('--cross_domain_datasets', type=str, nargs='+', default=['cifar100_224', 'imagenet-r', ltech-101', 'oxford-flower-102', 'food-101'], help='List of datasets for cross-domain experiments')
