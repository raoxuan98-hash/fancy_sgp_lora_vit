...
def build_parser() -> argparse.ArgumentParser:
    ...
    # basic.add_argument('--cross_domain_datasets', type=str, nargs='+', default=['imagenet-r', 'caltech-101', 'oxford-flower-102', 'cars196_224', 'cub200_224', 'food-101'], help='List of datasets for cross-domain experiments')
    ...
    inc.add_argument('--enable_incremental_split', type=bool, default=True,
    ...
    # Random Projector specific parameters
    model.add_argument('--random_projection', type=int, default=0, help='Dimension of random projection. If <= 0, no random projection is applied.')
    model.add_argument('--random_projection_dim', type=int, default=256, help='Dimension of random projection when random_projection > 0.')
    ...
    model.add_argument('--first_section_adaptation', action='store_true', default=True, help='Enable adaptation in the first section.')
