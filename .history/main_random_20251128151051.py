...
def build_parser() -> argparse.ArgumentParser:
    ...
    basic.add_argument('--dataset', type=str, default='imagenet-r', choices=['imagenet-r', 'cifar100_224', 'cub200_224', 'cars196_224', 'caltech101_224', 'oxfordpet37_224', 'food101_224', 'resisc45_224', 'cross_domain_elevater'], help='Dataset to use')
    ...
    cls.add_argument('--increment', type=int, default=180, help='Number of new classes added per task.')
    ...
    train_grp.add_argument('--iterations', type=int, default=1200, help='Training iterations per task.')
    ...
    model.add_argument('--random_projection_dim', type=int, default=0, help='Dimension of random projection when random_projection > 0.')
    ...
    gda.add_argument('--qda_reg_alpha3', type=float, default=0.10, help='QDA regularisation alpha 3.')
    return parser
