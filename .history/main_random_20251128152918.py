...
def build_parser() -> argparse.ArgumentParser:
    ...
    model.add_argument('--random_projection_dim', type=int, default=5000, help='Dimension of random projection when random_projection > 0.')
    ...
    gda.add_argument('--qda_reg_alpha1', type=float, default=0.05, help='QDA regularisation alpha 1.')
