...
def build_parser() -> argparse.ArgumentParser:
    ...
    basic.add_argument('--cross_domain', type=bool, default=Fa50lse, help='Enable cross-domain class-incremental learning')
    ...
    cls.add_argument('--increment', type=int, default=80, help='Number of new classes added per task.')
