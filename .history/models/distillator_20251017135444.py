...
class Distiller(nn.Module):
    ...
    def __init__(
        ...
        self.teacher: nn.Module | None = None  # Teacher model to be set externally
        logging.info(f"Distiller initialized: kd_type={kd_type}, gamma={gamma_kd}, identity={use_identity_linear}")
