...
from models.sldc_compensator_rebuttal1 import Drift_Compensator
...
class SubspaceLoRA(BaseLearner):
    ...
    def refine_classifiers(self):
        self.fc_dict = self.drift_compensator.refine_classifiers_from_variants(self.network.fc, self.ca_epochs, use_qda=True)
