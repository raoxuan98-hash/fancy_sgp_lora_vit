...
from models.sldc_compensator_rebuttal3 import Drift_Compensator# , RegularizedGaussianClassifier
...
class SubspaceLoRA(BaseLearner):
    ...
    def loop(self, data_manager) -> Dict[str, List[float | None]]:
        ...
        for task_id in range(data_manager.nb_tasks):
            ...
            if task_id == data_manager.nb_tasks - 1 or (task_id + 1) == 2 or (task_id + 1) % 10 == 0:
