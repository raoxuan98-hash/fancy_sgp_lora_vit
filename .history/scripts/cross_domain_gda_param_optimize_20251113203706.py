...
* No incremental learning - direct optimization on concatenated datasets
* QDA parameters constrained to sum to 1

For the concatenated datasets, we:
...
def optimise_concatenated_datasets(
    ...
    """Optimize GDA parameters on concatenated cross-domain datasets."""
    logging.info("===== Processing concatenated cross-domain datasets =====")
    
    # Use a placeholder dataset name for the concatenated scenario
...
def main() -> None:
    ...
    logging.info("Starting optimization on concatenated cross-domain datasets...")
