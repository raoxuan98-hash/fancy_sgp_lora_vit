...
{
    run_experiment_type "basic_lora" "basic_lora" "0" "--gamma_kd" "0.0" "--hopfield_temp" "0.05" "--hopfield_topk" "400" "--feature_combination_type" "combined" "--auxiliary_data_size" "4096"
} &
PIDS+=($!)
