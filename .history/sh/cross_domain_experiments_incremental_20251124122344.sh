...
echo "Experiment variants: 8 (basic_lora, lora_kd_1.0, lora_kd_0.5, nsp_lora_0.05, nsp_lora_0.10, sgp_lora_t1.0_p1.0, sgp_lora_t2.0_p2.0, sgp_lora_t1.5_p1.5)"
echo "GPUs used: ${GPUS[@]} (5 GPUs available)"
echo "Execution strategy: Phased parallel execution"
echo "  - Phase 1: basic_lora, lora_kd_1.0, lora_kd_0.5, nsp_lora_0.05, nsp_lora_0.10"
echo "  - Phase 2: sgp_lora_t1.0_p1.0, sgp_lora_t2.0_p2.0, sgp_lora_t1.5_p1.5"
echo "Configuration: vit-b-p16-clip, enable_incremental_split=True, num_incremental_splits=2"
echo "GPU allocation strategy: Optimized parallelization with balanced GPU utilization"