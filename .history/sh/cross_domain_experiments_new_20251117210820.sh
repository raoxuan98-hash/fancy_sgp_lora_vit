...
echo "=========================================="
echo "PHASE 1: Running LoRA-NSP and LoRA-SGP Experiments"
echo "=========================================="
...
echo "=========================================="
echo "PHASE 2: Running Other Experiments"
echo "=========================================="
...
# 4. 运行LoRA + 蒸馏跨域实验 (gamma_kd=1.0) (GPU 1)
{
...
# 4b. 运行LoRA + 蒸馏跨域实验 (gamma_kd=0.5) (GPU 2)
{
