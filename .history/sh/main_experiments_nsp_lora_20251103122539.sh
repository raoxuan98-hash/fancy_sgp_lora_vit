...
# 创建日志目录
LOG_DIR="logs/nsp_lora_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$LOG_DIR"
...
for SEED in "${SEEDS[@]}"; do
    echo "Running LoRA-NSP experiment: dataset=$DATASET, seed=$SEED, GPU=$GPU"
...
echo "LoRA-NSP experiments completed. Logs saved to $LOG_DIR"