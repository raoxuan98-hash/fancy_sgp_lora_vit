...
# 创建日志目录
LOG_DIR="logs/within_domain_sgp_lora_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$LOG_DIR"
...
for SEED in "\${SEEDS[@]}"; do
    echo "Running LoRA-SGP experiment: dataset=\$DATASET, seed=\$SEED, GPU=\$GPU"
...
echo "LoRA-SGP experiments completed. Logs saved to $LOG_DIR"