...
echo "Starting complete experiments with all parameter variants..."

# 创建总日志目录
MASTER_LOG_DIR="logs/complete_experiments_$(date +%Y%m%d_%H%M%S)"
...
echo "=========================================="
echo "All complete experiments finished!"
