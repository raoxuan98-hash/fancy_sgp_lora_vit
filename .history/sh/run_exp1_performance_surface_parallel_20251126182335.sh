...
# vit-b-p16 使用 GPU 0
GPU_EXPERIMENTS[0]="vit-b-p16:1:0:vit-b-p16-rank1 vit-b-p16:32:0:vit-b-p16-rank32"
# vit-b-p16-clip 使用 GPU 1
GPU_EXPERIMENTS[1]="vit-b-p16-clip:1:1:vit-b-p16-clip-rank1 vit-b-p16-clip:32:1:vit-b-p16-clip-rank32"
# vit-b-p16-dino 使用 GPU 2
GPU_EXPERIMENTS[2]="vit-b-p16-dino:1:2:vit-b-p16-dino-rank1 vit-b-p16-dino:32:2:vit-b-p16-dino-rank32"
# vit-b-p16-mocov3 使用 GPU 4
GPU_EXPERIMENTS[4]="vit-b-p16-mocov3:1:4:vit-b-p16-mocov3-rank1 vit-b-p16-mocov3:32:4:vit-b-p16-mocov3-rank32"
