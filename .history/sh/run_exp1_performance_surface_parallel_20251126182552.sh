...
GPU_EXPERIMENTS[1]="vit-b-p16-clip:1:1:vit-b-p16-clip-rank1 "
# vit-b-p16-dino 使用 GPU 2
GPU_EXPERIMENTS[2]="vit-b-p16-dino:1:2:vit-b-p16-dino-rank1 "
# vit-b-p16-mocov3 使用 GPU 4
GPU_EXPERIMENTS[4]="vit-b-p16-mocov3:1:4:vit-b-p16-mocov3-rank1"
