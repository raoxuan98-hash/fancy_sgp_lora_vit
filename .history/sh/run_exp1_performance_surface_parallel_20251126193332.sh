...
# 按GPU分组实验配置 - 每个模型测试多个rank值
declare -A GPU_EXPERIMENTS
# vit-b-p16 使用 GPU 0, 测试rank=8,16,32
GPU_EXPERIMENTS[0]="vit-b-p16:8:0:vit-b-p16-rank8 vit-b-p16:16:0:vit-b-p16-rank16 vit-b-p16:32:0:vit-b-p16-rank32"
# vit-b-p16-clip 使用 GPU 1, 测试rank=8,16,32
GPU_EXPERIMENTS[1]="vit-b-p16-clip:8:1:vit-b-p16-clip-rank8 vit-b-p16-clip:16:1:vit-b-p16-clip-rank16 vit-b-p16-clip:32:1:vit-b-p16-clip-rank32"
# vit-b-p16-dino 使用 GPU 2, 测试rank=8,16,32
GPU_EXPERIMENTS[2]="vit-b-p16-dino:8:2:vit-b-p16-dino-rank8 vit-b-p16-dino:16:2:vit-b-p16-dino-rank16 vit-b-p16-dino:32:2:vit-b-p16-dino-rank32"
# vit-b-p16-mocov3 使用 GPU 4, 测试rank=8,16,32
GPU_EXPERIMENTS[4]="vit-b-p16-mocov3:8:4:vit-b-p16-mocov3-rank8 vit-b-p16-mocov3:16:4:vit-b-p16-mocov3-rank16 vit-b-p16-mocov3:32:4:vit-b-p16-mocov3-rank32"
...
echo "使用GPU: ${GPUS[@]}"
echo "架构分配:"
echo "  vit-b-p16: GPU 0 (串行运行rank=8,16,32)"
echo "  vit-b-p16-clip: GPU 1 (串行运行rank=8,16,32)"
echo "  vit-b-p16-dino: GPU 2 (串行运行rank=8,16,32)"
echo "  vit-b-p16-mocov3: GPU 4 (串行运行rank=8,16,32)"
echo "=================================="
