CUDA_VISIBLE_DEVICES=0 python3 -u main.py --dataset "cifar100_224" --smart_defaults --distillation_transform 'linear' &

sleep 15

CUDA_VISIBLE_DEVICES=1 python3 -u main.py --dataset "cars196_224" --smart_defaults --distillation_transform 'linear' & 
