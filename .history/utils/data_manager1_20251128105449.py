...
class IncrementalDataManager:
    ...
    def get_incremental_subset(self, task_id: int, source: str = "train", cumulative:bool=False, transform = None) -> Dataset:
        return self.get_subset(task_id, source, cumulative, transform)
