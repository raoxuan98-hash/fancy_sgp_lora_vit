...
dataset = CrossDomainDataManagerCore(cross_domain_datasets, shuffle=False, seed=0, num_shots=64)
...
train_indices, test_indices = random_split(subsets, [split1_size, split2_size])

train_subsets = train_indices
...
def evaluate_qda_classifier(alpha1, alpha2, alpha3, stats, features, targets, dataset_ids, device="cuda", batch_size=512):
...
def run_experiment3_classifier_comparison(sgd_epochs=5, sgd_lr=0.01, save_path=None):
    ...
    from classifier.gaussian_classifier import NCMClassifier
