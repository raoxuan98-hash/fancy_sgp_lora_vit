...
def extract_features_and_labels(model, loader, num_shots, cache_dir="cached_data/classifier_ablation"):
    """
    提取特征和标签，支持缓存功能
    """
    # 检查缓存
...
train_features, train_labels, train_dataset_ids, test_features, test_labels, test_dataset_ids = extract_features_and_labels(vit, loaders, num_shots=num_shots)
