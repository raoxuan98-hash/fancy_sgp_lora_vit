...
def evaluate_qda_classifier(alpha1, alpha2, alpha3, stats, features, targets, dataset_ids,
    ...
    参数:
        return_dataset_wise: 布尔值，控制返回dataset-wise的平均准确度还是全部样本的准确度
                            True: 返回各数据集准确率的平均值
                            False: 返回所有样本的总体准确度
    """
...
alpha1_values, alpha2_values, accuracy_matrix = grid_search_alpha1_alpha2(
    alpha1_min=0, alpha1_max=3.0, alpha2_min=0, alpha2_max=3.0,
    alpha1_points=6, alpha2_points=6, return_dataset_wise=False)
